...
- Prompt Example
    ...
    On identifying relevant tools to answer this prompt, Copilot will in response, ask for permission to run any of these tools. This indicates a successful integration with the MCP server.
...
By providing structured and consistent access to data, MCP makes it significantly easier to build intelligent agents and complex AI workflows. This is a huge advantage for observability, as there is potential for greater productivity with new use-cases like automated RCA, proactive incident remediation, and continuous monitoring, made possible.
